    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                <h1 class="h2">Input Transaction</h1>
                <form method="post" action="{{ url('/transaction') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="txtnominal" type="number" class="form-control" id="" aria-describedby="">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Keterangan</label>
                        <input type="text" name="txtketerangan" class="form-control" id="" aria-describedby="">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Kategori</label>
